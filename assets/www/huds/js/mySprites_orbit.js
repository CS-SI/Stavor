...
function updateLatitudeSprite(lat){
	//Update Sprite
	var messageLatitude = " Ï†="+parseFloat((lat * 180) / Math.PI).toFixed(1)+"º ";
...
function updateLongitudeSprite(lng){
	//Update Sprite
	var messageLongitude = " Î»="+parseFloat((lng * 180) / Math.PI).toFixed(1)+"º ";
...
function updateAnglesSprite(angle){
	//Update Sprite
	var messageAngles = " Î±="+parseFloat((angle * 180) / Math.PI).toFixed(1)+"º ";
