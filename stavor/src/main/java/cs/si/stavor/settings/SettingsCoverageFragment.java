 ...
 *
 */
public class SettingsCoverageFragment extends PreferenceFragment {
	/**
	 ...
	 */
	public static SettingsCoverageFragment newInstance(int sectionNumber) {	
		SettingsCoverageFragment fragment = new SettingsCoverageFragment();
